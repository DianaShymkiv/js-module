...
// Сумма цифр числа
// Дано натуральное число N. Вычислите сумму его цифр.При решении этой задачи нельзя использовать строки, массивы ну и циклы
...
// let recursion = (n) => Math.floor(n < 10 ? n : n % 10 + recursion(n / 10));

// Сумма цифр числа
// Дано натуральное число N. Вычислите сумму его цифр.При решении этой задачи нельзя использовать строки, массивы, методы, рекурсию, регулярные выражения ну и циклы
//
// пример:
// 1234 -> 10 -> 1
// 879 -> 24 -> 6
...
// let recursion = (n) => Math.floor(n < 10 ? n : recursion(n % 10 + recursion(n / 10)));

// console.log(recursion(56731));
