...
//
//     let monthDurationElement = document.createElement('h3');
//     monthDurationElement.innerText = `${item.monthDuration} - month`;
//     let hourDurationElement = document.createElement('h3');
//     hourDurationElement.innerText = `${item.hourDuration} - hours`;
//
...
//     div.appendChild(monthDurationElement);
//     div.appendChild(hourDurationElement);
//     divContent.appendChild(modulesElement);
